...
> **Recommended: use the built-in trainer instead of Teachable Machine.**
> Open `trainer.html` on the mirror PC. It records through the mirror's own
> camera and glass, uses the exact crops the app uses, trains in the browser
> and installs with one tap. It also has an **Evaluate** step for your results
> chapter.
>
> | Slot | Page | Record |
> |---|---|---|
> | Glasses | `trainer.html?slot=glasses` | wearing glasses / no glasses, 150+ each |
> | Face covered | `trainer.html?slot=occlusion` | covered / clear, 150+ each |
> | Makeup quality | `trainer.html?slot=quality` | per step (lips, blush, eyebrows, contour): good / smudged / uneven / too much or too little, 200+ good and as many of each problem as you can |
>
> **Evaluate (step 5):** switch *Recording into* to **Test set** and record
> people who were **not** used for training. Press **Evaluate** to get
> accuracy, precision, recall, F1 and a TP/FP/FN/TN table for the current
> pixel rules **and** the model on the same samples, then **Download Results
> (CSV)**. That before/after comparison is the evidence for Objective 9.
>
> Teachable Machine (below) still works if you prefer it.
