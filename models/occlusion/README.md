...
**Recommended:** train it at the mirror with `trainer.html?slot=occlusion`
(record *Face covered* / *Face clear*, then Train, then Install on This Mirror).
A model installed there is used before anything in this folder.
