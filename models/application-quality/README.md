...
**Recommended:** train it at the mirror with `trainer.html?slot=quality`. It
records the exact zone crop described below, trains a sigmoid head with this
class order, and installs with one tap. A model installed there is used before
